...
public class AdmHeritage extends javax.swing.JFrame {

    public AdmHeritage() {
        initComponents();
        show_nig();
        setResizable(false);
        setTitle("Heritage site");
    }
    public ArrayList<Heritage> resList(){
         ...
         try {
           ...
           // create the connection object
            ...
            Heritage detailhos;
            while(rs.next()){
                detailhos = new Heritage(rs.getInt("rID"),rs.getString("rName"),rs.getString("rLocation"),rs.getString("rPhone"),rs.getString("rEmail"),rs.getString("openTime"));
    ...
    private void registerHeritage(){
        ...
        Heritage detailher = new Heritage(id,name,location,phone,email,open);
        heritagecontroller = new HeritageController();
        int insert = heritagecontroller.registerHeritage(detailher);
...
//            st = con.createStatement();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Heritage Sites Information");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        if(!checkFields()){
            ...
            query = "update  sanjin_heritage set rName = ?,rLocation = ?,rPhone = ?,rEmail = ?,opentime=? where rId = ?; ";
            try {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        PreparedStatement ps=null;
        Connection con=mySqlConn();
        String qry="delete from sanjin_heritage where rId=? ; ";
        try{
