...
public class AdmNightlife extends javax.swing.JFrame {

    public AdmNightlife() {
        initComponents();
        show_nig();
        setResizable(false);
        setTitle("Nightlife Detail");
    }
...
//            // create the connection object
    ...
    private void registerNightlife(){
        ...
        Nightlife detailnig = new Nightlife(id,name,location,phone,email,open);
        nightlifecontroller = new NightlifeController();
        int insert = nightlifecontroller.registerNightlife(detailnig);
...
//            st = con.createStatement();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Nightlife Information");
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        if(!checkFields()){
            ...
            query = "update  sanjin_nightlife set rName = ?,rLocation = ?,rPhone = ?,rEmail = ?,opentime=? where rId = ?; ";
            try {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        PreparedStatement ps=null;
        Connection con=mySqlConn();
        String qry="delete from sanjin_nightlife where rId=? ; ";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdmNightlife.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
