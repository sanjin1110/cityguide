 ...
 * @author user
 */
public class OtherHospital extends javax.swing.JFrame {

    /**
     * Creates new form OtherHospital
     */
    public OtherHospital() {
        initComponents();
        show_hos();
        setResizable(false);
        setTitle("Other Hospitals");
        setDefaultCloseOperation(OtherHospital.DISPOSE_ON_CLOSE);
...
//            // create the connection object
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtherHospital.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
